...
var NCMBQuery = /** @class */ (function () {
    ...
    NCMBQuery.equalTo = function (name, value) {
        return this.setOperand(name, value);
    };
    NCMBQuery.notEqualTo = function (name, value) {
        return this.setOperand(name, value, '$ne');
    };
    NCMBQuery.greaterThan = function (name, value) {
        return this.setOperand(name, value, '$gt');
    };
    NCMBQuery.greaterThanOrEqualTo = function (name, value) {
        return this.setOperand(name, value, '$gte');
    };
    NCMBQuery.lessThan = function (name, value) {
        return this.setOperand(name, value, '$lt');
    };
    NCMBQuery.lessThanOrEqualTo = function (name, value) {
        return this.setOperand(name, value, '$lte');
    };
    NCMBQuery.in = function (name, value) {
        return this.setOperand(name, value, '$in');
    };
    NCMBQuery.notIn = function (name, value) {
        return this.setOperand(name, value, '$nin');
    };
    NCMBQuery.exists = function (name) {
        return this.setOperand(name, true, '$exists');
    };
    NCMBQuery.notExists = function (name) {
        return this.setOperand(name, false, '$exists');
    };
    NCMBQuery.inArray = function (name, value) {
        return this.setOperand(name, value, '$inArray');
    };
    NCMBQuery.notInArray = function (name, value) {
        return this.setOperand(name, value, '$ninArray');
    };
    NCMBQuery.allInArray = function (name, value) {
        return this.setOperand(name, value, '$all');
    };
    NCMBQuery.setOperand = function (name, value, operand) {
    ...
    NCMBQuery.limit = function (value) {
        limit = value;
        return this;
    };
    NCMBQuery.skip = function (value) {
        offset = value;
        return this;
    };
    NCMBQuery.order = function (name, desc) {
    ...
    NCMBQuery.include = function (name) {
        include = name;
        return this;
    };
    NCMBQuery.fetch = function () {
        return __awaiter(this, void 0, NCMBQuery, function () {
    ...
    NCMBQuery.prototype.delete = function () {
        return __awaiter(this, void 0, void 0, function () {
    ...
    NCMBQuery.prototype.toJSON = function () {
        var _this = this;
        var json = {};
    ...
    NCMBQuery.prototype.save = function () {
        return __awaiter(this, void 0, void 0, function () {
